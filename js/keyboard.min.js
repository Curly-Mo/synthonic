...
function touchend(a){var b=parseInt(a.target.id.substring(1));console.log("touchend: id: "+a.target.id+" note:"+b);NaN!=b&&noteOff(b+12*(3-currentOctave));pointers[a.pointerId]=null;document.getElementById("keybox");a.preventDefault()}function touchcancel(a){console.log("touchcancel");a.preventDefault()}function pointerDown(a){var b=parseInt(a.target.id.substring(1));isNaN(b)||(noteOn(b+12*(3-currentOctave),.75),document.getElementById("keybox"),pointers[a.pointerId]=b);a.preventDefault()}
function pointerMove(a){var b=parseInt(a.target.id.substring(1));!isNaN(b)&&pointers[a.pointerId]&&pointers[a.pointerId]!=b&&(pointers[a.pointerId]&&noteOff(pointers[a.pointerId]+12*(3-currentOctave)),noteOn(b+12*(3-currentOctave),.75),pointers[a.pointerId]=b);a.preventDefault()}function pointerUp(a){var b=parseInt(a.target.id.substring(1));NaN!=b&&noteOff(b+12*(3-currentOctave));pointers[a.pointerId]=null;document.getElementById("keybox");a.preventDefault()}
function initKeyboard(){keybox=document.getElementById("keybox");keybox.addEventListener("mousedown",pointerDown);keybox.addEventListener("mousemove",pointerMove);keybox.addEventListener("mouseup",pointerUp);window.addEventListener("keydown",keyDown,!1);window.addEventListener("keyup",keyUp,!1)}document.addEventListener("DOMContentLoaded",function(){initKeyboard()},!1);
